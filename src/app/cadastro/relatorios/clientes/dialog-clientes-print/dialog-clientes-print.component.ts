...
@Component({
  selector: 'app-dialog-clientes-print',
  templateUrl: './dialog-clientes-print.component.html',
  styleUrls: ['./dialog-clientes-print.component.css'],
  providers:[
    DatePipe,MaskPipe
  ]
})
export class DialogClientesPrintComponent implements OnInit {
