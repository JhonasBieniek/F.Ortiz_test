...
export class DialogSendNotaComponent implements OnInit {
  ...
  criaParcelas() {
    ...
    if (this.pedido.condicao_comercial.dias != null) {
      ...
      let auxValor = valor * (this.pedido.auxiliar_porcentagem / 100); // Validar 
      let venValor = valor * (this.pedido.vendedor_porcentagem /100); // Validar
      let fortiz_valor = valor * ((this.pedido.comissao_media - this.pedido.vendedor_porcentagem - this.pedido.auxiliar_porcentagem )/100); // Validar
